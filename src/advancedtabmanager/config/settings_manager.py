...
class SettingsManager:
    ...
    def save_settings(self, ui_elements):
        ...
        self.settings.setValue("disable_notifications", ui_elements.get('disable_notifications_checkbox', False).isChecked())
        self.settings.setValue("disable_web_security", ui_elements.get('disable_web_security_checkbox', False).isChecked())
        self.settings.setValue("no_sandbox", ui_elements.get('no_sandbox_checkbox', False).isChecked())
        self.settings.setValue("disable_dev_shm", ui_elements.get('disable_dev_shm_checkbox', False).isChecked())
    ...
    def load_settings(self, ui_elements):
        ...
        ui_elements.get('disable_notifications_checkbox', lambda: None).setChecked(self.settings.value("disable_notifications", False, type=bool))
        ui_elements.get('disable_web_security_checkbox', lambda: None).setChecked(self.settings.value("disable_web_security", False, type=bool))
        ui_elements.get('no_sandbox_checkbox', lambda: None).setChecked(self.settings.value("no_sandbox", False, type=bool))
        ui_elements.get('disable_dev_shm_checkbox', lambda: None).setChecked(self.settings.value("disable_dev_shm", False, type=bool))
